...
import BusinessUpdateComponent from '@/entities/business/business-update.vue';
import BusinessClass from '@/entities/business/business-update.component';
...
describe('Component Tests', () => {
  describe('Business Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<BusinessClass>(BusinessUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        businessServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(businessServiceStub.update.calledWith(entity)).toBeTruthy();
