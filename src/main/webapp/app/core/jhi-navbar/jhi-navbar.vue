    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">hotelga_server</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/room-sell-details">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.roomSellDetails')">RoomSellDetails</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/room-sell-info">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.roomSellInfo')">RoomSellInfo</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/affiliate-member">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.affiliateMember')">AffiliateMember</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/coupon">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.coupon')">Coupon</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/published-coupon-info">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.publishedCouponInfo')">PublishedCouponInfo</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/coupon-published-histories">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.couponPublishedHistories')">CouponPublishedHistories</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/published-coupon-histories">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.publishedCouponHistories')">PublishedCouponHistories</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/invite-card">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.inviteCard')">InviteCard</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/apply-invite-card">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.applyInviteCard')">ApplyInviteCard</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/reservation">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.reservation')">Reservation</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/payment">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.payment')">Payment</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/accommodation-sales">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.accommodationSales')">AccommodationSales</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/business">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.business')">Business</span>
                    </b-dropdown-item>
